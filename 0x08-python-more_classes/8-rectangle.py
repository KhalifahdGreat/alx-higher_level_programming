...
class Rectangle:
    ...
    def __str__(self):
        ...
        i.e. to use str(rectangle) and print(rectangle)
        """
        ...
        for i in range(self.__height):
            [total.append(str(self.print_symbol)) for j in range(self.__width)]
    ...
    because this static method doesn’t take any parameters like self and cls.
    """
    @staticmethod
